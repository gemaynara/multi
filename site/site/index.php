...
<head>
  ...
  <title><?=$dadosgerais->nomedosite;?> - Catálogo digital</title>
    ...
    <div class="container pt-5 pb-4">
      <div class="row">
        <div class="text-lg-left text-left align-self-left pt-4 col-md-6 py-3" style="">
          <h2 class="text-dark"><b class="">Aumente suas vendas com um nosso sistema integrado ao seu <b class="text-success">WhatsApp.</b></b></h2>
          <p class="text-dark"><b>Facilidade para você e para o seu cliente!<br></b><br>
            ...
            <i class="fa fa-check-circle text-primary" aria-hidden="true"></i> O cliente escolhe o produto, monta o pedido<br>
            <i class="fa fa-check-circle text-primary" aria-hidden="true"></i> Adiciona as informações e finaliza<br>
            <i class="fa fa-check-circle text-primary" aria-hidden="true"></i> Você recebe o pedido no seu WhatsApp ou no Painel Administrativo<br>
            <i class="fa fa-check-circle text-primary" aria-hidden="true"></i> Tudo organizado e sem taxas mensais<br>
          </p>
		  <br>
          <a class="btn btn-lg btn-primary" href="<?=$dadosgerais->urlsite;?>/clientedemo" target="blank"><b>Ver demostração</b></a>
        </div>
  ...
  <div class="text-center py-5">
    <div class="container">
      <div class="col-md-12 text-center">
        <h1>Veja como é rápido e simples!</h1>
        <p>Comece hoje a vender online e receba os seus pedidos de forma organizada no seu WhatsApp.</p>
      </div>
      <div class="row">
        <div class="col-lg-4 p-3">
          <div class="card">
            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="img/1.png" width="230">
              <p class="lead"><b>Faça seu cadastro completo do seu cardápio</b></p>
        ...
        <div class="col-lg-4 p-3 col-md-6">
          <div class="card">
            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="img/2.png" width="230">
              <p class="lead"><b>Compartilhe o seu link nas Redes Socias.</b></p>
              <p class="mb-0">Ao construir seu cardápio e ativá-lo, será gerado um link para divulgação. Compartilhe por e-mail, redes sociais e Whatsapp. Crie novas formas de vender seus produtos, seja criativo!</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 p-3 col-md-6">
          <div class="card">
            <div class="card-body p-4" style=""> <img class="img-fluid d-block mb-3 mx-auto" src="img/3.png" width="230">
              <p class="lead"><b>Receba o no seu Whatsapp e PDV.</b></p>
              <p class="mb-0">Seu cliente navega pelo cardápio de forma simples e escolhe os itens do cardápio. Você recebe o pedido diretamente por Whatsapp, fácil de organizar e entregar!</p>
            </div>
          </div>
        </div>
      </div>
