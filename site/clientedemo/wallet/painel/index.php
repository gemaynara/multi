...
session_start();
	...
	$buscauser       = $connect->query("SELECT idu, funcionarios.setor_id, setores.descricao FROM funcionarios, setores WHERE setores.setor_id = funcionarios.setor_id   and login='$login_cpf' AND senha='$login_snh' AND acesso='2'");
	...
	$cookie_cel_100 = "setorx";

	$cookie_value100 = $dadoscliente->setor_id;
	$_SESSION["setor"] = $dadoscliente->setor_id;
	$_SESSION["setor_desc"] = $dadoscliente->descricao;
	...
	setcookie($$cookie_cel_100, $cookie_value100, time() + (86400 * 90));
  ...
  <body>
    ...
    <div class="signin-wrapper">
      ...
      <div class="signin-box" align="center">
        ...
        <h3 class="slim-logo">Painel Wallet<span></h3>
