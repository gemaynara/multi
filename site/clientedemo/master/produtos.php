            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group">
                  ...
                  <label class="form-control-label">Categoria/Subcategoria: <span class="tx-danger">*</span></label>
					...
					<option style="background-color: #e0e0e0; text-transform: uppercase;" value="<?php print $idca = $dadossel->id.'- 0';?>"> <?php print $nomca = $dadossel->nome;?></option>

					<?php 

					$selsubcat = $connect->query("SELECT * FROM sucategoria WHERE idu = '$cod_id' and categoria_pai = $dadossel->id ORDER BY id ASC");

					while ($dadosselsub = $selsubcat->fetch(PDO::FETCH_OBJ)) { 

					?>
					<option value="<?php print $idSubca = $dadossel->id.'-'.$dadosselsub->id;?>">  &#x21B3 <?php print $nomSubca =  $dadosselsub->Descricao;?></option>
				...
				<div class="form-group">
                  ...
                  <label class="form-control-label">Setor: <span class="tx-danger">*</span></label>
                    ...
                    <select class="form-control" name="cad_setor" required>
					...
					<option value="<?php print $idset = $dadossel->setor_id;?>"><?php print $nomca = $dadossel->descricao;?></option>
			  ...
			  <div class="col-lg-4">
                ...
                <div class="form-group">
                  ...
                  <label class="form-control-label">Tempo Padrão (minutos): <span class="tx-danger">*</span></label>

                  <input type="number" class="form-control" id="dinheiro" name="cad_tempo" maxlength="10" value="0,00"required>
          ...
          <div class="table-wrapper">
            ...
            <table id="datatable1" class="table display responsive nowrap" width="100%">
              ...
              <tbody>
				...
				$busSubcat = $connect->query("SELECT * FROM sucategoria WHERE id =  '$dadcate->subcategoria'");
				$busSubcat = $busSubcat->fetch(PDO::FETCH_OBJ);
                ...
                <tr>
				  ...
				  <td><?php print $busSubcat->Descricao;?></td>
