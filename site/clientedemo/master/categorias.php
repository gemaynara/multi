...
<div class="slim-mainpanel">
      ...
      <label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> Cadastrar Subcategoria</label>

        <hr>

        <form action="" method="post" enctype="multipart/form-data">

        <input type="hidden" name="cadSubcate" value="ok">
            ...
            <div class="form-layout">
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <label class="form-control-label">Categoria Pai: <span class="tx-danger">*</span></label>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Subcad_nome" maxlength="120" required>
          ...
          <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" name="Subpic" id="Subpic" class="form-control">
            ...
            <table id="datatable1" class="table display responsive nowrap" width="100%">
              ...
              <tbody>
                ...
                <?php 
                      ...
                      $selSubcat = $connect->query("SELECT * FROM sucategoria WHERE idu = '$cod_id' and categoria_pai = $dadcate->id ORDER BY id ASC");

                      while ($selSubcatm = $selSubcat->fetch(PDO::FETCH_OBJ)) { 
                ...
                <tr>
                  ...
                  <td width="10%"> <?php print $dadcate->id.'.'.$selSubcatm->id;?></td>

                  <td width="6%"><img src="../img/categoria/Sub/<?php if(!$selSubcatm->url){echo "off.jpg";}else{ print $selSubcatm->url;}?>" width="40"/></td>

                  <td><?php print $selSubcatm->Descricao;?></td>
                  <td><?php print ""; ?></td>
                  
                  
                  <td align="center">

                  <form action="Subcategoriaseditar.php" method="post">

                        <input type="hidden" name="codigoc" value="<?php print $selSubcatm->id;?>"/>
                  ...
                  <form action="" method="post">
                        ...
                        <input type="hidden" name="deletarSubcat" value="<?php print $selSubcatm->id;?>"/>
