      ...
      <div class="slim-sidebar">
        ...
        <ul class="nav nav-sidebar">
          ...
          <li class="sidebar-nav-item">
            ...
            <a href="setores.php" class="sidebar-nav-link"><i class="fa fa-sitemap mg-r-10" style="font-size:16px"></i> Setores</a>
          ...
          <li class="sidebar-nav-item">
            ...
            <a href="wallet.php" class="sidebar-nav-link"><i class="fa fa-tag mg-r-10" style="font-size:16px"></i> Wallet</a>
