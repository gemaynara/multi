...
<div class="slim-mainpanel">
	  ...
	  <div class="section-wrapper mg-b-20">
          ...
          <label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> Cadastrar Wallet</label>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-3">
                ...
                <div class="form-group">
                  ...
                  <label class="form-control-label">Nº Wallet: <span class="tx-danger">*</span></label>
		...
		<div class="section-wrapper">
          ...
          <div class="table-wrapper">
            ...
            <table id="datatable1" class="table display responsive nowrap" width="100%">
			  ...
			  $mesass = $connect->query("SELECT * FROM wallet WHERE idu = '$cod_id' ORDER BY numero ASC");
			  ...
			  ?>
                ...
                <tr>
				  ...
				  <a href="https://api.qrserver.com/v1/create-qr-code/?data=<?php print $sitexx;?>wallet/?idwallet=<?php print $dadosmesa->numero;?>&amp;size=400x400" target="_blank">
	              ...
	              <input type="hidden" name="delWallet" value="<?php print $dadosmesa->id;?>"/>
