...
if(isset($_POST["solicitaWallet"]))  {

	$update = $connect->query("UPDATE carros SET status='2' WHERE status = 1 and placa='".$_POST["placa"]."'");
...
$update = $connect->query("UPDATE carros SET status='2' WHERE status = 1 and placa= (select placa from pedidos where idpedido='".$_POST["finalizado"]."' );");
      ...
      <div class="container">
		  ...
		  <div class="col-md-6">
			...
			<div class="card card-people-list pd-15 mg-b-10">
				...
				<div class="col-md-4" align="center" style="font-size:20px; margin-top:5px;"> </div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					...
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLongTitle">Solicitar Wallet</h5>
					...
					<div class="modal-body">
						...
						<input type="hidden" name="solicitaWallet" value="<?=$codigop;?>">
