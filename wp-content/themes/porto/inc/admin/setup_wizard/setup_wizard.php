		...
		public function porto_setup_wizard_default_plugins() {
			...
			<form method="post">
				...
				if ( count( $plugins['all'] ) ) {
					...
					<div class="notice notice-warning<?php echo ! $notice_hidden ? '' : ' d-none'; ?>" style="margin: 0 0 1em">
						<p style="margin: .5em 0;"><?php esc_html_e( 'It isn\'t recommended to use two page builders(Elementor and WPBakery) together. It might give serious effects on your site\'s view and performance.', 'porto' ); ?></p>
					</div>
