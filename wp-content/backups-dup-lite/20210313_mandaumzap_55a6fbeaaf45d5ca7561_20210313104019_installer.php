...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210313_mandaumzap_55a6fbeaaf45d5ca7561_20210313104019_archive.zip';
	const ARCHIVE_SIZE		 = '196302030';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '55a6fbe-13104019';
    const SECONDARY_PACKAGE_HASH = '9a80bd1-13104019';
	const VERSION			 = '1.4.0';
